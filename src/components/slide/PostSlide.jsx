...
const GrideSlide = (props) => {
    ...
    return (
        ...
        <div className='loop-item relative flex flex-col justify-end rounded-lg h-full p-8 lg:p-6 text-left object-cover transition-all ease-linear hover:scale-110' style={divStyle}>
